...
const LaneGuides: React.FC = () => {
    ...
    return (
        <group position={[0, 0.02, 0]}>
            ...
            {/* Lane Separators - Glowing Lines (Orange/Pink) */}
            {separators.map((x, i) => (
...
const RetroSun: React.FC = () => {
    ...
    const uniforms = useMemo(() => ({
        uTime: { value: 0 },
        uColorTop: { value: new THREE.Color('#FFAB00') }, // Amber/Gold
        uColorBottom: { value: new THREE.Color('#D500F9') } // Deep Purple
    }), []);
...
export const Environment: React.FC = () => {
  return (
    <>
      ...
      <directionalLight position={[0, 20, -10]} intensity={1.5} color="#FF6D00" />
      <pointLight position={[0, 25, -150]} intensity={2} color="#D500F9" distance={200} decay={2} />
